...
//            MENU_ITEM_STATIC_FUNC("DFT_Test", Test, 0),
            //  MENU_ITEM_ENTER_FUNC("DFT_Test", Test, 0),
             MENU_ITEM_ENTER_FUNC("DFT_Measure", DFT_Measure, 0),
//             MENU_ITEM_ENTER_FUNC("DFT_Test", Test, 0),
//            MENU_ITEM_STATIC_FUNC("DFT_Measure", DFT_Measure, 0),
            MENU_ITEM_FLOAT_SHOW("main_freq:", &main_frequency, 1),
            MENU_ITEM_FLOAT_SHOW("vpp:", &vpp, 0),


            MENU_ITEM_FLOAT_EDIT("freq_pt_max:", &main_frequency_protect_max, 1000, 1),
            MENU_ITEM_FLOAT_EDIT("freq_pt_min:", &main_frequency_protect_min, 1000, 0),
    ...
    static MenuPage Page = {"Measure", .line = LineList, .open_status = 0} ;
